...
const changePassword = async (e)=>{
  try {
    ...
    const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}admin/changePasswordRole`,payload,{
      headers: {
      ...
      <MainPanel>
        <div class="panel">
          ...
          <form class="form" onSubmit={changePassword} >
            ...
            <div class="form-row">
              <SelectInput value={formData.role} onChange={(e)=>setFormData({...formData,role:e.target.value})} >
